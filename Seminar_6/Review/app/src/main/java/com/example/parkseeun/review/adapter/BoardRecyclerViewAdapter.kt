package com.example.parkseeun.review.adapter
...
import com.example.parkseeun.review.R
import com.example.parkseeun.review.WriteActivity
...
//        requestOptions.override(150)
    ...
    inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val rv: RelativeLayout = itemView.findViewById(R.id.btn_rv_item_kakao_talk_room) as RelativeLayout
    }
}